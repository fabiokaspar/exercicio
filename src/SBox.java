...
public class SBox {
	 ...
	 public String getElementFromS1 (int index) {
		 return S1[index];
	 }
	 
	 public String getElementFromS2 (int index) {
		 return S2[index];
	 }
	 
	 public String getElementFromS3 (int index) {
		 return S3[index];
	 }
	 
	 public String getElementFromS4 (int index) {
		 return S4[index];
	 }
